...
<div class="side-menu">
    ...
    <ul>
        <li><a href="./gamerQuiz.php" target="contentFrame"><img src="../images/icons8-quizlet-50 (1).png" alt="">&nbsp;
                <span>Quiz</span></a></li>
        <li><a href="./changePassword.php" target="contentFrame"><img src="../images/icons8-user-50.png" alt="">&nbsp;
                <span>Mon&nbsp;compte</span></a></li>
        <li><a href="./gamerResults.php" target="contentFrame"><img src="../images/icons8-test-results-50 (1).png"
