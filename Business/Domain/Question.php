...
class Question
{
     ...
     */
    public function __construct(string $questionText, string $correctAnswer, string $wrongAnswer1, string $wrongAnswer2, string $wrongAnswer3, Quiz $quiz, ?string $imageUrl = null, ?int $id = null)
    {
